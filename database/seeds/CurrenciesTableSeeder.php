...
class CurrenciesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $currencies = array(
            ...
            [ "code" => "CNY", "name" => "Renminbi (Chinese) yuan[8]" ],
            [ "code" => "COP", "name" => "Colombian peso" ],
            [ "code" => "COU", "name" => "Unidad de Valor Real (UVR) (funds code)[9]" ],
            ...
            [ "code" => "MRU[12]", "name" => "Mauritanian ouguiya" ],
            ...
            [ "code" => "PHP", "name" => "Philippine piso[13]" ],
            ...
            [ "code" => "STN[14]", "name" => "São Tomé and Príncipe dobra" ],
            ...
            [ "code" => "ZWL", "name" => "Zimbabwean dollar A/10" ],
        );
